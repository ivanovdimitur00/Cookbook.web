...
namespace Cookbook.web.Controllers
{
    public class IngredientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,IsAllergen,CreatedBy,ModifiedBy,Id,CreatedOn,ModifiedOn")] Ingredient ingredient)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Name,IsAllergen,CreatedBy,ModifiedBy,Id,CreatedOn,ModifiedOn")] Ingredient ingredient)
        {
            if (id != ingredient.Id)
            {
                return NotFound();
